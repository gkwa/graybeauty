...
import (
	...
	"github.com/gkwa/graybeauty/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.graybeauty.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".graybeauty")
	}
